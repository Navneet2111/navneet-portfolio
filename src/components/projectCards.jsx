function ProjectCard({ title, description, image, link }) {
  return (
    <a
      ...
      className="bg-white text-black min-w-[230px] rounded-2xl shadow-lg p-2 transform transition-transform duration-300 hover:scale-105 cursor-pointer relative group"
    >
