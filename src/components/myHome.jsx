  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center lg:text-left">
        ...
        <p className="text-lg px-4 md:text-xl text-gray-600 mt-4 max-w-xl animate-fade-in-up transition-opacity duration-700 ease-in text-justify cursor-pointer">
